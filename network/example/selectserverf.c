/*
** selectserver.c -- a cheezy multiperson chat server for static clients
*/
...
int main(void) {
  ...
  const int nummax = 2; // maximum number of clients connected
  int numexist = 0;     // number of existing connections
