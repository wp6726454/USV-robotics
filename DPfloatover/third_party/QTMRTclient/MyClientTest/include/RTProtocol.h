...
class CRTProtocol {
 ...
 public:
  ...
  bool Connect(char *pServerAddr, unsigned short nPort,
               unsigned short *pnUDPServerPort = NULL,
  ...
  bool GetCurrentFrame(unsigned int nComponentType,
                       const char *selectedAnalogChannels = NULL);
  ...
  bool SaveCapture(char *pFileName, bool bOverwrite, char *pNewFileName = NULL,
  ...
  bool GetCameraOrientation(unsigned int nCameraIndex, int &nOrientation);
  ...
  bool GetForcePlate(unsigned int nPlateIndex, unsigned int &nID,
                     ...
                     char *&pType, char *&pName, float &fLength, float &fWidth);
 ...
 private:
  ...
  void AddXMLElementBool(CMarkup *oXML, const _TCHAR *tTag, const bool *pbValue,
                         const _TCHAR *tTrue = _T("True"),
                         const _TCHAR *tFalse = _T("False"));
  ...
  void AddXMLElementUnsignedInt(CMarkup *oXML, const _TCHAR *tTag,
                                const unsigned int *pnValue);
  void AddXMLElementFloat(CMarkup *oXML, const _TCHAR *tTag,
                          const float *pfValue, unsigned int pnDecimals = 6);
