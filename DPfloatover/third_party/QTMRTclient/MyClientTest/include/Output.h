...
public:
  ...
  void HandleDataFrame(FILE *logfile, bool bLogMinimum,
                       CRTProtocol *poRTProtocol, CInput::EOperation operation,
...
private:
  ...
  void PrintData3D(FILE *logfile, CRTPacket *poRTPacket,
                   CRTProtocol *poRTProtocol);
  void PrintData3DRes(FILE *logfile, CRTPacket *poRTPacket,
                      CRTProtocol *poRTProtocol);
  ...
  void PrintData6DEulerRes(FILE *logfile, CRTPacket *poRTPacket,
                           CRTProtocol *poRTProtocol);
  void PrintDataGazeVector(FILE *logfile, CRTPacket *poRTPacket,
                           CRTProtocol *poRTProtocol);
