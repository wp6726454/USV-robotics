...
int onestepqp() {
  ...
  const MSKint32t numvar = 6, numcon = 1;
  ...
  double blx[] = {0.0, 0.0, 0.0, -MSK_INFINITY, -MSK_INFINITY, -MSK_INFINITY};
  double bux[] = {+MSK_INFINITY, +MSK_INFINITY, +MSK_INFINITY,
                  +MSK_INFINITY, +MSK_INFINITY, +MSK_INFINITY};

  double c[] = {0.0, 0.0, 0.0, 1.0, 1.0, 1.0};

  MSKint32t aptrb[] = {0, 1, 2, 3, 3, 3}, aptre[] = {1, 2, 3, 3, 3, 3},
            asub[] = {0, 0, 0, 0};
  ...
  if (r == MSK_RES_OK) {
    ...
    if (r == MSK_RES_OK) {
      ...
      if (r == MSK_RES_OK) {
        ...
        r = MSK_appendcone(task, MSK_CT_QUAD,
      ...
      if (r == MSK_RES_OK) {
        ...
        r = MSK_appendcone(task, MSK_CT_RQUAD, 0.0, 3, csub);
      }
