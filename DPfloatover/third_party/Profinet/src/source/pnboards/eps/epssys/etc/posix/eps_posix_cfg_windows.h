...
#define EPS_POSIX_THREAD_PRIORITY_NORMAL    		WIN_P15
#define EPS_POSIX_THREAD_PRIORITY_ABOVE_NORMAL   	WIN_P27		
#define EPS_POSIX_THREAD_PRIORITY_HIGH           	WIN_P30
#define EPS_POSIX_THREAD_PRIORITY_HIGH_PERFORMANCE 	WIN_P31
