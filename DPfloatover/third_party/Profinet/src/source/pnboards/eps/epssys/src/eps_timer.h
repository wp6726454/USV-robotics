...
LSA_UINT16 eps_timer_start_tgroup0     ( LSA_TIMER_ID_TYPE timer_id, LSA_USER_ID_TYPE user_id, LSA_UINT16 time  );
LSA_UINT16 eps_timer_stop_tgroup0     ( LSA_TIMER_ID_TYPE timer_id );
LSA_UINT16 eps_timer_free_tgroup0     ( LSA_TIMER_ID_TYPE timer_id );
...
LSA_UINT16 eps_timer_start_tgroup1     ( LSA_TIMER_ID_TYPE timer_id, LSA_USER_ID_TYPE user_id, LSA_UINT16 time  );
LSA_UINT16 eps_timer_stop_tgroup1      ( LSA_TIMER_ID_TYPE timer_id );
LSA_UINT16 eps_timer_free_tgroup1      ( LSA_TIMER_ID_TYPE timer_id );
