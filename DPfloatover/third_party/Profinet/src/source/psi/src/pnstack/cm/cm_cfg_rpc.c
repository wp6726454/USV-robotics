...
#define CM_MODULE_ID       32057
#define LTRC_ACT_MODUL_ID  32057
...
LSA_VOID CM_RPC_LOWER_OUT_FCT_ATTR CM_RPC_OPEN_CHANNEL_LOWER(
	...
	LSA_SYS_PTR_TYPE          sys_ptr )
{
	...
	CM_ASSERT( pSys->comp_id_lower == LSA_COMP_ID_CLRPC );
...
LSA_VOID CM_RPC_LOWER_OUT_FCT_ATTR CM_RPC_CLOSE_CHANNEL_LOWER(
	CM_RPC_LOWER_RQB_PTR_TYPE lower_rqb_ptr,
	LSA_SYS_PTR_TYPE          sys_ptr )
{
	PSI_SYS_PTR_TYPE pSys = (PSI_SYS_PTR_TYPE)sys_ptr;
...
LSA_VOID CM_RPC_LOWER_OUT_FCT_ATTR CM_RPC_REQUEST_LOWER(
	CM_RPC_LOWER_RQB_PTR_TYPE lower_rqb_ptr,
	LSA_SYS_PTR_TYPE          sys_ptr )
{
	PSI_SYS_PTR_TYPE pSys = (PSI_SYS_PTR_TYPE)sys_ptr;
	...
	PSI_SYSTEM_TRACE_03( pSys->trace_idx, LSA_TRACE_LEVEL_CHAT,
		"CM_RPC_REQUEST_LOWER(): rqb(%08x) h(%d) opc(%d)",
		lower_rqb_ptr,
...
LSA_VOID CM_SYSTEM_OUT_FCT_ATTR CM_RPC_ALLOC_LOWER_RQB(
	...
	LSA_SYS_PTR_TYPE                              sys_ptr )
{
    ...
    if ( length != sizeof(CM_RPC_LOWER_RQB_TYPE) )
    {
		PSI_SYSTEM_TRACE_00( pSys->trace_idx, LSA_TRACE_LEVEL_FATAL,
			"CM_RPC_ALLOC_LOWER_RQB(): invalid length != sizeof(CM_RPC_LOWER_RQB_TYPE)" );
	...
	PSI_SYSTEM_TRACE_01( pSys->trace_idx, LSA_TRACE_LEVEL_CHAT, "CM_RPC_ALLOC_LOWER_RQB(): ptr(%08x)", *lower_rqb_ptr_ptr);
}
#else
#error "by design a function!"
#endif
...
LSA_VOID CM_SYSTEM_OUT_FCT_ATTR CM_RPC_FREE_LOWER_RQB(
	...
	LSA_SYS_PTR_TYPE                              sys_ptr )
{
	...
	PSI_SYSTEM_TRACE_01( pSys->trace_idx, LSA_TRACE_LEVEL_CHAT, "CM_RPC_FREE_LOWER_RQB(): ptr(%08x)", lower_rqb_ptr);
...
LSA_VOID CM_SYSTEM_OUT_FCT_ATTR CM_RPC_ALLOC_LOWER_MEM(
	...
	LSA_SYS_PTR_TYPE                              sys_ptr )
{
    ...
    {
		PSI_SYSTEM_TRACE_00( pSys->trace_idx, LSA_TRACE_LEVEL_FATAL,
			"CM_RPC_ALLOC_LOWER_MEM(): invalid length 0" );
	...
	PSI_SYSTEM_TRACE_01( pSys->trace_idx, LSA_TRACE_LEVEL_CHAT, "CM_RPC_ALLOC_LOWER_MEM(): ptr(%08x)", *lower_mem_ptr_ptr);
}
#else
#error "by design a function!"
#endif
...
LSA_VOID CM_SYSTEM_OUT_FCT_ATTR CM_RPC_FREE_LOWER_MEM(
	LSA_UINT16                CM_LOCAL_MEM_ATTR * ret_val_ptr,
	...
	LSA_SYS_PTR_TYPE                              sys_ptr )
{
	...
	PSI_SYSTEM_TRACE_01( pSys->trace_idx, LSA_TRACE_LEVEL_CHAT, "CM_RPC_FREE_LOWER_MEM(): ptr(%08x)", lower_mem_ptr);
...
LSA_VOID CM_SYSTEM_OUT_FCT_ATTR CM_RPC_LOWER_RQB_ERROR(
	CM_RPC_LOWER_RQB_PTR_TYPE rpc_lower_rqb_ptr )
{
	PSI_RQB_ERROR( LSA_COMP_ID_CM, LSA_COMP_ID_CLRPC, rpc_lower_rqb_ptr );
}
#else
#error "by design a function!"
#endif
