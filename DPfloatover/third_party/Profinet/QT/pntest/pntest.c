...
void SERV_CP_Startup() {
  ...
  hXMLFile = fopen(
      "/home/skloe/Coding/CPP1X/USV/DPfloatover/third_party/Profinet/src/"
      "examples/test_app/linux32/PNDriverBase_TestApp/test.xml",
      "rb");
  ...
  if (hXMLFile == NULL) {
    ...
    if (result == PNIO_OK) {
      ...
      ret_val =
          SERV_CP_startup(&locID, 1, (PNIO_UINT8*)xml_buffer, xml_file_size,
                          (PNIO_UINT8*)rema_buffer, rema_file_size, &sd);
